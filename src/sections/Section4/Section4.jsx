      ...
      <div className="sub-section4">
        ...
        <div className="section4-right-content">
          ...
          <div className="section4-description">
            ...
            <p>
            We fulfill this mission through engaging, hands-on learning experiences that offer college dance students the tools and confidence they need to navigate the competitive dance industry. Our work exposes students to the realities of the dance <b>world beyond the classroom, </b> offering insights into both the challenges and opportunities that await them.
            </p>

            <p>
            Whether it’s learning about contracts, grant writing, marketing, or career planning, we’re here to guide dancers in <b>transforming their passion into a fulfilling and financially sustainable profession.</b>
            </p>
